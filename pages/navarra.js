...
(function () {
  ...
  function render(r, datos) {
    ...
    if (faqDinamica) {
      faqDinamica.textContent =
        (datos.territorio === "navarra" ? "En Navarra, " : "Con el territorio seleccionado, ") +
  ...
  function calcular() {
    ...
    // Navarra usa el motor foral; el resto de territorios siguen con el común,
    // para que el selector siga siendo útil sin duplicar reglas fiscales.
