 ...
 * el 01/01/2026. Datos proporcionados directamente por el usuario a partir
 * de la norma oficial — no se ha navegado para verificarlos en esta tarea.
 *
...
(function (root, factory) {
  ...
  function Constants2026FuentesNavarra(c) {
    c.FUENTES = {
      tablaRetencion: {
        norma: "Decreto Foral 148/2025, de 23 de diciembre (da nueva redacción al Reglamento del IRPF de Navarra)",
        articulo: "Art. 71 Reglamento IRPF Navarra",
        url: "(proporcionado por el usuario; pendiente de enlace oficial verificado — no se ha navegado en esta tarea)",
        anio: 2026,
        estado: "confirmado por el usuario a partir de la norma oficial, sin verificación propia por navegación"
      },
      minoracionDiscapacidad: {
        norma: "Decreto Foral 148/2025, de 23 de diciembre",
        articulo: "Art. 71 Reglamento IRPF Navarra",
        url: "(proporcionado por el usuario; pendiente de enlace oficial verificado — no se ha navegado en esta tarea)",
        anio: 2026,
        estado: "confirmado por el usuario a partir de la norma oficial, sin verificación propia por navegación"
